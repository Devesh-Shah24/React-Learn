...
const Card = ({ badge, image, category, title, desc, features, oldPrice, newPrice, reviews, stock }) => {
  return (
    <div className="card">
      ...
      <div className="info">
        ...
        <div className="bottom">
          ...
          <button className="btn">
            ...
            <svg className="icon" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2"
              viewBox="0 0 24 24">
